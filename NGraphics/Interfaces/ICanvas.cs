...
namespace NGraphics.Interfaces
{
    ...
    public static class CanvasEx
    {
        ...
        {
            canvas.DrawRectangle(frame, new Pen(color, width));
        }
        ...
        public static void DrawLine(this ICanvas canvas, Point start, Point end, Color color, bool isAbsolute,
            double width = 1.0)
        {
        ...
        public static void DrawLine(this ICanvas canvas, double x1, double y1, double x2, double y2, Color color,
            bool isAbsolute, double width = 1.0)
        {
            var p = new Path {Pen = new Pen(color, width)};
